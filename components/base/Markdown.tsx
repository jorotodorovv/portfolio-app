...
import LevelComponent from './LevelElement';
...
const components: Components = {
    ...
    ul: ({ children, node }) => <LevelComponent element='ul' node={node} styles={ulStyles} className='pl-5 text-muted-foreground'>{children}</LevelComponent>,
    li: ({ children, node }) => <LevelComponent element='li' node={node} styles={liStyles}>{children}</LevelComponent>,
    p: ({ children, node }) => <LevelComponent element='p' node={node} styles={pStyles} className='text-muted-foreground'>{children}</LevelComponent>,
